#$Id: OntologyServer.pm,v 1.95 2006/02/07 18:22:00 mwilkinson Exp $
...
sub Relationships {
	...
	my %results = [];
	while ($term
		&& (!($term =~/urn\:lsid\:biomoby.org\:objectclass\:Object\:/ ))
		&& (!($term =~ /urn\:lsid\:biomoby.org\:servicetype\:Service\:/ ) ))
	{
