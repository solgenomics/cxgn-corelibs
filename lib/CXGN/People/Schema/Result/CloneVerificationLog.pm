use utf8;
package CXGN::People::Schema::Result::CloneVerificationLog;
...
=head1 TABLE: C<clone_verification_log>

=cut

__PACKAGE__->table("clone_verification_log");

=head1 ACCESSORS

=head2 clone_verification_log_id

  data_type: 'integer'
  is_auto_increment: 1
  is_nullable: 0
  sequence: 'sgn_people.clone_verification_log_clone_verification_log_id_seq'
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:hPpN+4sjbAWWqvFSOI/yuw
