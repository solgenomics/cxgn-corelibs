...
sub merge {
    ...
    ##
    my $female_parent_id = SGN::Model::Cvterm->get_cvterm_row($self->get_schema,'female_parent','stock_relationship')->cvterm_id();
    my $male_parent_id   = SGN::Model::Cvterm->get_cvterm_row($self->get_schema,'male_parent', 'stock_relationship')->cvterm_id();
