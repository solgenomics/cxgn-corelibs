...
#print STDERR "XXXX: before cluster \n";
my $cluster_obj = CXGN::Phylo::Cluster->new(\@labels, \%ij_dist);
#print STDERR "XXXX: after cluster, before best_n_partition \n";

my ($max_avg_intercluster_dist, $str) = $cluster_obj->best_n_partition(); # default: bipartition, max avg inter-cluster dist

 # print "XXX: $sum_tvd, $n_histograms \n";
...
#print "Q3s:  $upper_quartile  ; from...: ", $DStat_obj->quantile(3), "\n";
