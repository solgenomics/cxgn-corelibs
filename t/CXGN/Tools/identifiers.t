...
BEGIN {
  ...
  our %tests =
    (
     ...
     'C12.4_contig0'   => ['tomato_contig', 'C12.4_contig0', qr//, { chr => 12, chr_ver => 4, ctg_num => 0, ver => 4 }],
     'c02.42coNTig0'   => ['tomato_contig', 'C02.42_contig0', qr//, { chr => 2, chr_ver => 42, ctg_num => 0, ver => 42 }],
