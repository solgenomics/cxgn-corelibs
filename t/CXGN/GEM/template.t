...
=head1 DESCRIPTION
 ...
 This script check 92 variables to test the right operation of the 
...
my $last_dbiref_id = $nextvals{'dbiref'} || 0;
my $last_dbipath_id = $nextvals{'dbipath'} || 0;
...
## This test doesn't set table sequences anymore (these methods are deprecated)
