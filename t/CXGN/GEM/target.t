...
my $last_target_id = $nextvals{'ge_target'} || 0;
my $last_target_element_id = $nextvals{'ge_target_element'} || 0;
...
## This test does not set the table sequences anymore (these methods are deprecated)
